...
//      Adafruit NeoPixel Stick 8 PWB Model
//
//  Parameters:
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////
module ada_nps8_pwb_model(xy_center = false) {
    ...
    translate(xy_origin_translation) {
        ...
        color("darkolivegreen", alpha = 1.0) {
            render() difference() {
                cube([ada_nps8_pwb_length, ada_nps8_pwb_width, ada_nps8_pwb_height]);
                union() {
                    translate([pwb_hole1_x, pwb_hole1_y, 0.0])
                        cylinder(h = ada_nps8_pwb_height, r = pwb_hole1_r);
                    translate([pwb_hole2_x, pwb_hole2_y, 0.0])
                        cylinder(h = ada_nps8_pwb_height, r = pwb_hole2_r);
                    ...
                    for (i = [ 0: 3 ]) { // 4 pads per on each end of board
                        ...
                        translate([ (ada_nps8_pwb_length - pwb_pad_center_x1 - pwb_pad_length/2),
                                    (pwb_pad_center_y1 + i*pwb_pad_pitch_y - pwb_pad_width/2),
                                     0])
                            cube([pwb_pad_length, pwb_pad_width, pwb_pad_height]);
                    }
        ...
        for (i = [ 0 : len(c0805_x) - 1 ]) {
            ...
            color((i>0) ? "sienna":"black") {
                translate([c0805_x[i], c0805_y, ada_nps8_pwb_height + c0805_height/2])
